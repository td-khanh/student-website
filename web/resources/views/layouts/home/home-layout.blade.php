...
<body>
<nav  class="navbar navbar-expand-lg navbar-light bg-light nav-cover">
    <div style="width: 30%;">
...
<div class="text-center text-lg-start bg-light text-muted">
    <img style="width:100% ;" src="{{asset('images/bannerIMG.png')}}" alt="">
</div>
<!-- Footer -->
<footer class="text-center text-lg-start bg-light text-muted">
  ...
  <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.05);">
    © 2021 Copyright:
    <a class="text-reset fw-bold" href="#">FPT-education</a>
  </div>
  <!-- Copyright -->
</footer>
<!-- Footer -->
